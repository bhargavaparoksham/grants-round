...
import {GrantApplication, Program, ProjectCredential, ProjectStatus, Round} from "./features/api/types"
...
export const makeGrantApplicationData = (overrides: Partial<GrantApplication> = { }, projectOverrides = {}): GrantApplication => ({
...
export const makeProjectCredentialData = (overrides: Partial<ProjectCredential> = {}) => ({
    input: "",
    credential: {
        "@context": [
